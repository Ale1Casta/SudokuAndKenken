...
Pacchetti disponibili dopo l'aggiunta al path:
  ...
  puzzler.sudoku          — Sudoku classico 4×4 / 9×9 / 16×16
  puzzler.kenken          — KenKen n×n
  puzzler.diagonal        — Diagonal Sudoku (variante: +2 Distinct sulle diagonali)
  puzzler.hyper           — Hyper Sudoku   (variante: +4 Distinct sulle finestre, solo 9×9)
  puzzler.nonconsecutive  — Nonconsecutive Sudoku (variante: |a-b|≠1 per celle adiacenti, solo 9×9)
"""
import sys
